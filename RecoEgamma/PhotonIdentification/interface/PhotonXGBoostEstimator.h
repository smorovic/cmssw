...
public:
  ...
  float computeMva(float rawEnergyIn, float r9In, float sigmaIEtaIEtaIn, float etaWidthIn, float phiWidthIn, float e2x2In, float etaIn, float hOvrEIn, float ecalPFIsoIn) const;
