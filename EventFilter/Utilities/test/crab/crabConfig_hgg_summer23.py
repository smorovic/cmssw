...
config.JobType.psetName = 'hltMC_2023.py'

#config.Data.inputDataset = '/EphemeralHLTPhysics0/Run2023C-v1/RAW'
config.Data.inputDataset = '/GluGluHToGG_M-125_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer23BPixDRPremix-130X_mcRun3_2023_realistic_postBPix_v5-v2/GEN-SIM-RAW'
