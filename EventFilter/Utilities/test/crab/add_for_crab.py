...
#MVA path sequence (no filters, unseeded)
...
#MVA path (only prescale filter)
process.HLT_Diphoton_MVA = cms.Path( process.HLTBeginSequence + process.hltPreDiphotonMVA + process.HLTDiphotonMvaTestSequence  + process.HLTDiphotonMVATestProducer + process.HLTDiphotonMVATestCombFilter + process.HLTEndSequence )
...
#full schedule
process.schedule = cms.Schedule( *(process.L1Seed, process.L1Seed_And_Filter, process.HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90_v20, process.HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95_v20, process.HLT_Diphoton_MVA))
