...
process.MessageLogger = cms.Service( "MessageLogger",
    ...
    default = cms.untracked.PSet(
      ...
      statisticsThreshold = cms.untracked.string( "ERROR" ),
...
process.source = cms.Source("FedRawDataInputSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        ram_dir_path+"run100101_ls0003_index000000.raw",
        ram_dir_path+"run100101_ls0004_index000000.raw",
        ram_dir_path+"run100101_ls0005_index000000.raw",
        ram_dir_path+"run100101_ls0006_index000000.raw",
        ram_dir_path+"run100101_ls0007_index000000.raw",
        ram_dir_path+"run100101_ls0008_index000000.raw",
        ram_dir_path+"run100101_ls0009_index000000.raw",
        ram_dir_path+"run100101_ls0010_index000000.raw"
    )
