...
#ifdef DEBUG_EGAMMA_MVA
{
    ...
    //} catch(...) {
    //  std::cout << "WARNING: MISSING COMBINED CUT PARAMETERS" << std::endl;
    //}
    ...
    t_->Branch("pathAcceptMVA", &pathAcceptMVA_, "pathAcceptMVA/I");
...
#ifdef DEBUG_EGAMMA_MVA
  pathAcceptMVA_ = hltFilter(recCollection, mvaScoreMap);
#endif
...
#ifdef DEBUG_EGAMMA_MVA
bool MVATestProducer::hltFilter(edm::Handle<reco::RecoEcalCandidateCollection> const& recCollection,
